...
class MultiHeadAttention(nn.Module):
    ...
    Splits input into multiple heads, performs attention,
...
class PositionwiseFeedForward(nn.Module):
    """
    Applies two-layer feedforward network with ReLU activation.
    """
...
class TransformerClassifier(nn.Module):
    """
    Transformer-based classifier for MNIST.

    Converts image rows into sequence, applies encoder,
    and performs classification using pooled representation.
    """
